    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="{{ route('user.login') }}" method="POST">
                ...
                <div>
                    <button type="submit"
                        class="px-4 py-2 w-full  bg-blue-900 rounded-md text-white justify-center">Sign
                        in</button>
                </div>
                <div class="flex items-center gap-2">
                    <p>Do not have an account?</p>
                    <span class="underline hover:text-gray-500"><a href="{{ route('register') }}">sign up</a></span>
                </div>
            </form>
